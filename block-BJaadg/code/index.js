...
*/
console.log(from.concat("said that ", quote, " to ", to));
/*
...
*/
console.log(quote.endsWith("Only"));
/*
...
*/
let quote1 = quote.substring(0, 48);
console.log(quote1);
console.log(quote1.lastIndexOf("a"));
/*
